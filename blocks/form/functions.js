...
function populateReviewDetails(globals) {
  try {
    ...
    globals.functions.setProperty(
      review.loan_details.emi_amount_review,
      {
    ...
    globals.functions.setProperty(
      review.personal_details.mobile_no_review,
      {
        value:
          data.mobile_no || '',
      },
    ...
    globals.functions.setProperty(
      ...
      {
        value:
          'Adobe Systems India Pvt. Ltd. Salarpuria Sattva Knowledge Court, Bellandur, Bengaluru, Karnataka - 560103',
      },
    );
